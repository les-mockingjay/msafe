...
import org.ralasafe.client.privilege.Role;
...
public class UserCategoryManagerImpl implements UserCategoryManager {
	...
	/** key/value=id<Integer>/UserCategory<org.ralasafe.entitlement.entitle.UserCategory> */
	...
	private void loadXmlContent(UserCategory userCategory) {
		...
		if (!StringUtil.isEmpty(userCategory.getXmlContent())) {
			...
			org.ralasafe.entitlement.script.UserCategory scriptUserCategory = ScriptFactory
	...
	public UserCategoryTestResult testUserCategory(
			org.ralasafe.entitlement.script.UserCategory scriptUserCategory, User user,
			Map context) {
