...
public class BusinessData extends Node {
	...
	private int id;
	private String file;
	private org.ralasafe.entitlement.script.BusinessData scriptBusinessData;

	public org.ralasafe.entitlement.script.BusinessData getScriptBusinessData() {
		return scriptBusinessData;
	}

	public void setScriptBusinessData(
			org.ralasafe.entitlement.script.BusinessData scriptBusinessData) {
