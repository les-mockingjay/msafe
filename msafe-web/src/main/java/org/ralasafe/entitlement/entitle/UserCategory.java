...
public class UserCategory extends Node {
	...
	private String file;
	private org.ralasafe.entitlement.script.UserCategory scriptUserCategory;

	public org.ralasafe.entitlement.script.UserCategory getScriptUserCategory() {
		return scriptUserCategory;
	}

	public void setScriptUserCategory(
			org.ralasafe.entitlement.script.UserCategory scriptUserCategory) {
