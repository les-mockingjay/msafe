...
public class BusinessDataManagerImpl implements BusinessDataManager {
	...
	/** key/value=id<Integer>/businessData<org.ralasafe.entitlement.entitle.BusinessData> */
	...
	private void loadXmlContent(BusinessData businessData) {
		...
		if (!StringUtil.isEmpty(xmlContent)) {
			...
			org.ralasafe.entitlement.script.BusinessData scriptBusinessData = ScriptFactory
	...
	public BusinessDataTestResult testBusinessData(
			org.ralasafe.entitlement.script.BusinessData scriptBusinessData, User user,
			Map context) {
