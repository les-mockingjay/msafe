...
import org.ralasafe.user.adapter.UserComplexTableAdapter;
...
public class UserManager {
	 ...
	 * developer should customized query for select user, and return results in a customized javabean (not org.ralasafe.forclientintf.user.User).
	 *  
	 * @param user
	 * @param context
	 * @param key
